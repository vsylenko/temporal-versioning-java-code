...
alias ex1w="mvn exec:java -Dexec.mainClass='versionworkflow.LoanProcessingWorker'"
alias ex1st="mvn exec:java -Dexec.mainClass='versionworkflow.Starter' -Dexec.args='a100'"
